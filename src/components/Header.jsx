...
export default function Header() {
  ...
  // controla se o menu deve ser fechado ao clicar em uma opção
  const [closeMenuOnClick, setCloseMenuOnClick] = useState(true);
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between h-full pl-[50px] pr-[60px]">
        ...
        >
          <NavMobile closeMenuOnClick={closeMenuOnClick} setMobileNav={setMobileNav} />
        </div>
        {/* socials for desktop */}
        <div className="hidden xl:flex">
          <Socials />
