        ...
        <div className="flex flex-col items-center justify-between xl:flex-row gap-y-12">
          ...
          <div className="w-[150px] lg:w-[275px] flex flex-col items-center gap-y-6">
            <CircularProgressbar
              ...
              text={`${fullBody}%`}
            />
            <div className="font-light text-center uppercase">Realismo</div>
          </div>
          {/* progressbar 2 */}
          <div className="w-[150px] lg:w-[275px] flex flex-col items-center gap-y-6">
            <CircularProgressbar
              ...
              text={`${piercing}%`}
            />
            <div className="font-light text-center uppercase">Aquarela</div>
          </div>
          {/* progressbar 3 */}
          <div className="w-[150px] lg:w-[275px] flex flex-col items-center gap-y-6">
            <CircularProgressbar
              ...
              text={`${fullColor}%`}
            />
            <div className="font-light text-center uppercase">Retrato</div>
          </div>
          {/* progressbar 4 */}
          <div className="w-[150px] lg:w-[275px] flex flex-col items-center gap-y-6">
            <CircularProgressbar
